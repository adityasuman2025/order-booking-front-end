...
function AdminFilter(props) {
    ...
    const [ baseAPIEndPoint, setBaseAPIEndPoint ] = useState( "get-orders-by-city-list/?format=json&city=" );
    ...
    const [ paginationAPIEndPoint, setPaginationAPIEndPoint ] = useState( "get-orders-by-city-list/?format=json&city=" );
